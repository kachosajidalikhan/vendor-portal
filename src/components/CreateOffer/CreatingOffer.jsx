  ...
  return (
    ...
    <div className="flex bg-white h-screen">
      ...
      <div className="w-1/1 p-6 overflow-y-auto">
         <div className="absolute right-85 top-26 bottom-6 w-px h-130 bg-[#EE6295]"></div>
        ...
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="relative overflow-hidden">
            ...
            <input id="image-upload" required type="file" accept="image/*" className="hidden" onChange={handleImageUpload} />
          </div>
          ...
          <button type="submit" className="w-1/3  bg-[#E5024E] text-white py-2 Poppins-bold rounded-md hover:bg-rose-600 transition">
            Launch!
          </button>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto relative">
          ...
          <div className="bg-[#DD4F82] w-1/1 rounded-lg p-4 text-white relative overflow-hidden min-h-[300px]">
            ...
            <div className="relative z-10">
              ...
              {formData.targetedAudience && <div className="text-sm text-[#ffffff]/50">For: {formData.targetedAudience}</div>}
            </div>
